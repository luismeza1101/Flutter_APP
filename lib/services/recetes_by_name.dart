...
class RecetesByName extends StatelessWidget {
  const RecetesByName({super.key});

  Future<List<Map<String, dynamic>>> fetchRecipes() async {
    const apiKey = "1452c0b80cae40c981ad2f4f8941c4c2";
    final response = await http.get(Uri.parse(
        'https://api.spoonacular.com/recipes/complexSearch?apiKey=$apiKey&query=pasta&number=5'));
